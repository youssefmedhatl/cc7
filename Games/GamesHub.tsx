...
const games: { id: GameId; icon: string; titleKey: "matchGameTitle" | "sevenSecGameTitle" | "hearGameTitle"; descKey: "matchGameDesc" | "sevenSecGameDesc" | "hearGameDesc"; ready: boolean }[] = [
