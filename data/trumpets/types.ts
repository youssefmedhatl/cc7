...
/** CHANGED: the script now uses three voices — the Holy Father (mentor),
 * the Girl (curious learner) and the Angel (biblical guide for each trumpet). */
export type Speaker = "father" | "girl" | "angel";
