...
const introDialogue: DialogueLine[] = [
  ...
  { speaker: "father", text: { en: "The seventh.", ar: "السابع." } },
  { speaker: "girl", text: { en: "Then this is the end?", ar: "إذن هذه هي النهاية؟" } },
  { speaker: "father", text: { en: "Listen.", ar: "استمع." } },
  { speaker: "father", text: { en: "The seventh trumpet brings the vision to its climax.", ar: "البوق السابع يبلغ بالرؤيا ذروتها." } },
  { speaker: "girl", text: { en: "After everything we've seen...", ar: "بعد كل ما رأيناه..." } },
  { speaker: "father", text: { en: "Do not look away.", ar: "لا تحوّل بصرك." } },
];

const closingDialogue: DialogueLine[] = [
  { speaker: "girl", text: { en: "We've reached the seventh trumpet.", ar: "لقد وصلنا إلى البوق السابع." } },
  { speaker: "father", text: { en: "Yes.", ar: "نعم." } },
  { speaker: "girl", text: { en: "What should we take with us?", ar: "ماذا يجب أن نأخذ معنا؟" } },
  { speaker: "father", text: { en: "The Word we have heard, and the understanding we have gained.", ar: "الكلمة التي سمعناها، والفهم الذي اكتسبناه." } },
];
