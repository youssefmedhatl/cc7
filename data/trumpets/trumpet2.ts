...
const introDialogue: DialogueLine[] = [
  ...
  { speaker: "father", text: { en: "Something like a great mountain, burning with fire, is cast into the sea.", ar: "شيء كجبل عظيم متقد بالنار يُطرح في البحر." } },
  { speaker: "girl", text: { en: "A mountain?", ar: "جبل؟" } },
  { speaker: "father", text: { en: "That is how John describes the vision.", ar: "هكذا يصف يوحنا هذه الرؤيا." } },
  { speaker: "girl", text: { en: "Then show me.", ar: "إذن أرِني." } },
];

const closingDialogue: DialogueLine[] = [
  { speaker: "father", text: { en: "Now look again at the words of Scripture.", ar: "الآن انظر مرة أخرى إلى كلمات الكتاب المقدس." } },
];
...
const trumpet2: TrumpetData = {
  ...
  scriptureText: {
    ...
    ar:
      "[نص مؤقت — بانتظار التحقق] والملاك الثاني بوّق، فأُلقي إلى البحر كأنه جبل عظيم متقد بالنار، " +
      "فصار ثلث البحر دماً، ومات ثلث الخلائق التي في البحر، وأُهلك ثلث السفن.",
  },
  narration: {
    en:
