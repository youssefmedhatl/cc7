...
const introDialogue: DialogueLine[] = [
  ...
  { speaker: "father", text: { en: "A great star falls from heaven. Its name is Wormwood.", ar: "نجم عظيم يسقط من السماء. اسمه الأفسنتين." } },
  { speaker: "girl", text: { en: "What happens next?", ar: "ماذا يحدث بعد ذلك؟" } },
  { speaker: "father", text: { en: "Watch the vision. Then read what follows.", ar: "راقب الرؤيا. ثم اقرأ ما يليها." } },
];

const closingDialogue: DialogueLine[] = [
  { speaker: "father", text: { en: "Remember the name: Wormwood.", ar: "تذكّر الاسم: الأفسنتين." } },
];
...
const trumpet3: TrumpetData = {
  ...
  scriptureText: {
    ...
    ar:
      "[نص مؤقت — بانتظار التحقق] والملاك الثالث بوّق، فسقط من السماء كوكب عظيم متقد كمصباح، " +
      "وسقط على ثلث الأنهار وعلى ينابيع المياه. واسم الكوكب يُدعى الأفسنتين، فمات كثيرون من الناس " +
      "من المياه لأنها صارت مُرّة.",
  },
  narration: {
    en:
