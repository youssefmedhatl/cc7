...
export const accent: Record<Speaker, { ring: string; glow: string; label: string }> = {
  // Warm gold / ivory for the mentor.
  father: { ring: "#c9a15a", glow: "rgba(201,161,90,0.45)", label: "var(--gold-300)" },
        ...
        {imgFailed ? (
          ...
          <img
            ...
            style={{
              ...
              imageRendering: speaker === "angel" ? "auto" : "pixelated",
            }}
          />
        )}
      </div>
